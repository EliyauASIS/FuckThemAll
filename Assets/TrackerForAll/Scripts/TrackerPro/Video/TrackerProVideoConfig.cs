...
using TrackerPro.Unity.UI;
using TrackerPro.Unity;

namespace TrackerPro.Unity
{
  public class TrackerProVideoConfig : ModalContents
  {
    ...
    private TrackerProVideoSolution _solution;
    ...
    private void Start()
    {
      _solution = GameObject.Find("Solution").GetComponent<TrackerProVideoSolution>();
      InitializeContents();
    }
