...
namespace TrackerPro.Unity.Holistic
{
  public class HolisticTrackingSolution : ImageSourceSolution<HolisticTrackingGraph>
  {
    [SerializeField] public RectTransform _worldAnnotationArea;
    [SerializeField] public DetectionAnnotationController _poseDetectionAnnotationController;
    [SerializeField] public HolisticLandmarkListAnnotationController _holisticAnnotationController;
    [SerializeField] public PoseWorldLandmarkListAnnotationController _poseWorldLandmarksAnnotationController;
    [SerializeField] public MaskAnnotationController _segmentationMaskAnnotationController;
    [SerializeField] public NormalizedRectAnnotationController _poseRoiAnnotationController;
