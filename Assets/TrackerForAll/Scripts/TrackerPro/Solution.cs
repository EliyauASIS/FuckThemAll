...
#pragma warning restore IDE1006
    [HideInInspector]
    public TrackingEventHandler[] trackingEventHandlers;
    ...
    protected virtual IEnumerator Start()
    {
        ...
        trackingEventHandlers = FindObjectsOfType<TrackingEventHandler>();
        foreach (var trackingEventHandler in trackingEventHandlers)
        {
            trackingEventHandler.InitializeEvent();
        }
        bootstrap = FindBootstrap();
          Debug.Log($"bootstrap.isFinished:{bootstrap.isFinished},event count:{trackingEventHandlers.Length}");
